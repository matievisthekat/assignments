...
//--------------------------------------------------------------
    ...
    // compare to the partition app
	// the pointers move until they find a value that is on the wrong side of the partition
    public int partitionIt(int left, int right, long pivot)
       {
       int leftPtr = left - 1;           // left of first elem
       int rightPtr = right + 1;         // right of first element
       while(true)
          {
